    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            {isAddModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                    <div className="w-full max-w-sm rounded-xl bg-white p-6 shadow-xl border text-zinc-900">
                        <h3 className="text-xl font-bold mb-4">Set Savings Goal</h3>
                        <form onSubmit={submitAddGoal} className="space-y-4">
                            ...
                            <div className="flex justify-end gap-3 mt-6">
                                ...
                                <button type="submit" disabled={addGoalForm.processing} className="px-4 py-2 text-sm font-medium bg-zinc-900 text-white rounded-md hover:bg-zinc-800">Create Goal</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            {selectedGoal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                    <div className="w-full max-w-sm rounded-xl bg-white p-6 shadow-xl border text-zinc-900">
                        <h3 className="text-xl font-bold mb-4">Add funds to {selectedGoal.name}</h3>
                        <form onSubmit={submitAddFunds} className="space-y-4">
                            ...
                            <div className="flex justify-end gap-3 mt-6">
                                <button type="button" onClick={() => setSelectedGoal(null)} className="px-4 py-2 text-sm font-medium hover:bg-muted rounded-md">Cancel</button>
                                <button type="submit" disabled={addFundsForm.processing} className="px-4 py-2 text-sm font-medium bg-emerald-600 text-white rounded-md hover:bg-emerald-700">Confirm Deposit</button>
                            </div>
                        </form>
                    </div>
                </div>
